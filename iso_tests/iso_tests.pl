...
:- load_test_module(testsuite_iso_tests(iso_tests_common)).
...
%TODO: peek_byte predciate are not implemented.
...
behaves according to the ISO standard. The test raises an exception in
Ciao.".
...
behaves according to the ISO standard. The test raises an error.".
...
"ISO standard test. This test checks that the predicate peek_byte/2
behaves according to the ISO standard. The test raised an error.".
...
"Non ISO standard test. This test checks that the predicate
read_term/2 behaves according to the ISO standard. This test is expected 
to raise an error but the error raised is different to the one
specified by the standard. This test fails in Ciao.".
...
# 
"Extra tests for exception. This test checks that the predicate atom_code/2
	behaves accoding to the ISO standard.".
...
# 
"Extra tests for exception. This test checks that the predicate atom_code/2
	behave accoding to the ISO standard.".
...
:- test numbercodes_extra_errortest_1
	+ exception(error(instantiation_error, _ImpDep))
# 
"Extra tests for exception. This test checks that the predicate number_code/2
	behave accoding to the ISO standard.".

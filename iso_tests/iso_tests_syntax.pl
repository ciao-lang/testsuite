...
:- doc(module, "ISO standard tests for Ciao for syntax").
...
argument is the same as the standard one.".
...
"ISO standard test. This test checks that the Ciao definition of an
argument is the same as the standard one. This test succeeds".
...
"ISO standard test. This test checks that the Ciao definition of an
argument is the same as the standard one. The format of the error
raised does not match with the format specified by the ISO standard
for this case.".
...
among operands and operators are stablished according to the ISO
standard. The format of the error raised does not match with the
format specified by the ISO standard for this case.".
...
equivalent in functional notation. This test succeeds.".
...
functor {}/1 can also be expressed by enclosing its argument in curly
brackets. This test succeeds.".
...
"ISO standard test. This test checks that depending on the value of
the flag double_quotes a double quoted list is either an atom or a
list.".
...
of the flag double_quotes a double quoted list is either an atom or a
list.".
